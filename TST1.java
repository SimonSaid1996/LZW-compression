/*************************************************************************
 *  Compilation:  javac TST1.java
 *  Execution:    java TST1 < words.txt
...
/**
 *  The <tt>TST1</tt> class represents an symbol table of key-value
 ...
 */
public class TST1<Value> {
    private int N;              // size
    private Node<Value> root;   // root of TST1
    ...
    /**
     * Unit tests the <tt>TST1</tt> data type.
     */
    public static void main(String[] args) {

        // build symbol table from standard input
        TST1<Integer> st = new TST1<Integer>();
